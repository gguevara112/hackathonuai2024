...
import './History.css'; // Tu archivo CSS personalizado
...
const History = () => {
  ...
  return (
    <div className="container py-4">
      <div className="welcomeMessage">Your Docs</div> {/* Mensaje de bienvenida */}
            ...
            <div className="hero-pattern-card h-100 shadow-sm">
              ...
              <div className="card-footer text-center bg-light">
                ...
                >
                  ...
                  <div className="ovdnsdfsdfklwo">{topic.classes} pages</div>
                </button>
              </div>
            </div>
          </div>
